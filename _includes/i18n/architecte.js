const pageTranslations = {
  fr: {
    arch: {
          ...
          eco1Desc: "Dans un marché inondé par le bruit marketing, <strong>Renaud Varoqueaux</strong> effectue à lui seul un travail phénoménal de veille. Il anime de manière dynamique, pédagogique et sur un ton léger toutes les actualités de la tech, du digital et de l'IA. L'IA occupe aujourd'hui 99% de ses actualités, mais il ne s'y limite pas.<br>Il organise régulièrement des ateliers qui ont permis de développer plusieurs outils gratuits avec la communauté <a href='https://www.renaud-dekode.fr/' target='_blank'><strong>Renaud Dekode</strong></a>, et interviewe des personnalités de l'IA. Toute entreprise devrait inciter ses équipes IT à suivre sa chaîne.",
  ...
  en: {
    arch: {
          ...
          eco1Desc: "In a market flooded by marketing noise, <strong>Renaud Varoqueaux</strong> does a phenomenal job all by himself. He covers all tech, digital and AI news in a dynamic, pedagogical and light-hearted tone. AI currently accounts for 99% of his content, but he doesn't limit himself to it.<br>He regularly organizes workshops that have led to several free tools built with the <a href='https://www.renaud-dekode.fr/' target='_blank'><strong>Renaud Dekode</strong></a> community, and interviews AI personalities. Every company should encourage its IT teams to follow his channel.",
