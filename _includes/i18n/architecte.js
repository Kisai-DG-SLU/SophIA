const pageTranslations = {
  fr: {
    arch: {
          ...
          lead: "Je m'appelle Damien Guesdon. On ne sécurise pas une Intelligence Artificielle si l'on ne comprend pas le réseau sur lequel elle tourne. Mon approche de l'IA n'est pas algorithmique, elle est fondamentalement architecturale.",
  ...
  en: {
    arch: {
          ...
          lead: "My name is Damien Guesdon. You cannot secure an Artificial Intelligence if you don't understand the network it runs on. My approach to AI is not algorithmic; it is fundamentally architectural.",
