const pageTranslations = {
  fr: {
    arch: {
          ...
          act1Text1: "Quand l'IA générative grand public a explosé, j'y ai d'abord vu un moyen technique à explorer (low-code, vibe coding). En me plongeant sérieusement dans l'ingénierie IA, j'ai commencé à obtenir de bons résultats.",
          act1Text2: "Mais très vite en production, je me suis heurté à un mur opérationnel : hallucinations systématiques, coûts dérapants, hors-sujets, et surtout, un risque permanent de fuite de données. À chaque correction superficielle (prompt engineering de base), les défauts structurels finissaient par rejaillir.",
          act2Title: "L'impasse de la dépendance Cloud",
          act2Text1: "En parallèle, l'actualité sécuritaire m'a conforté dans cette impasse : l'ombre du Cloud Act, les dysfonctionnements des fournisseurs et les revues tarifaires arbitraires.",
          act2Text2: "Aujourd'hui, les géants américains déploient des plateformes agentiques \"clés en main\". L'entreprise y dépose ses données en échange d'une IA sur-mesure. De mon point de vue de directeur technique, c'est le piège ultime : un aller simple vers une ultra-dépendance et un <em>vendor lock-in</em> irréversible. L'objectif n'était pas de créer une autarcie isolée, mais de bâtir une véritable <strong>autonomie stratégique</strong>.",
  ...
  en: {
    arch: {
          ...
          act1Text1: "When mainstream generative AI exploded, I initially saw it as a technical avenue to explore (low-code, vibe coding). As I dove seriously into AI engineering, I started getting good results.",
          act1Text2: "But very quickly in production, I hit an operational wall: systematic hallucinations, spiraling costs, off-topic answers, and above all, a permanent risk of data leakage. With every superficial correction (basic prompt engineering), structural flaws eventually resurfaced.",
          ...
          act2Text2: "Today, American tech giants are deploying \"turnkey\" agentic platforms. The company deposits its data in exchange for a custom AI. From my point of view as a technical director, it's the ultimate trap: a one-way ticket to ultra-dependency and irreversible <em>vendor lock-in</em>. The goal was not to create an isolated autarky, but to build true <strong>strategic autonomy</strong>.",
