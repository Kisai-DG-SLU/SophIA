const pageTranslations = {
  fr: {
    arch: {
          ...
          eco3Desc: "Kevin Guegan adopte une vision opposée, plus philosophique. Gungnir y est doté d'une conscience persistante et de mécanismes d'auto-amélioration. Un projet ambitieux de Scarlet Wolf qui regroupe de nombreux outils, le tout déployable en un seul clic."
        },
  },
  en: {
    arch: {
          ...
          eco3Desc: "Kevin Guegan takes the opposite, more philosophical approach. Gungnir is endowed with a persistent consciousness and self-improvement mechanisms. An ambitious project by Scarlet Wolf bundling many tools, all deployable in one click."
        },
  }
};