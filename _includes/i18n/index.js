const pageTranslations = {
  fr: {
    ...
    solution: {
          ...
          intro: "C'est pour résoudre ce dilemme qu'a été conçue l'architecture SophIA : industrialiser l'IA sans s'enfermer dans le modèle propriétaire des MANGOS."
        },
    cards: { 
          control: { title: "1. Sécurité Absolue", text: "SophIA est un 'bunker' cognitif. Vos données ne quittent jamais l'entreprise. C'est une IA qui a la même puissance que les leaders du marché, mais qui tourne chez vous. Elle connaît vos règles, mais elle est physiquement incapable de les fuiter à l'extérieur." }, 
    ...
    posture: {
          ...
          intro: "Que vous soyez un leader français de l'IA construisant une plateforme produit (comme Mistral AI), ou une entreprise majeure souhaitant déployer sa propre plateforme interne, je peux intégrer vos équipes pour piloter cette vision technique.",
    ...
    cta: { title: "Construisons votre infrastructure souveraine.", text: "Si la vision d'une intelligence artificielle puissante, gouvernable et totalement indépendante des MANGOS résonne avec votre stratégie d'entreprise, discutons de la manière dont je peux diriger ce projet en interne.", contact: "Contactez-moi (contact@kisai.fr)" },
  },
  en: {
    hero: { 
    ...
    solution: {
          ...
          intro: "This dilemma drove the design of the SophIA architecture: industrializing AI without locking into the proprietary model of MANGOS."
        },
    cards: { 
          control: { title: "1. Absolute Security", text: "SophIA is a cognitive 'bunker'. Your data never leaves the company. It's an AI that has the same power as market leaders, but runs at your premises. It knows your rules, but is physically incapable of leaking them outside." }, 
    ...
    posture: {
          ...
          intro: "Whether you are a French AI leader building a product platform (like Mistral AI), or a major enterprise wanting to deploy its own internal platform, I can join your teams to steer this technical vision.",
          li1: "<strong>Head of AI Platform / VP Engineering</strong>",
